...
<body>
    ...
    color: white;">Quản lý người dùng</a></div>
            ...
            <div class="content-right">
                ...
                <form method="post" action="<?php echo BASE_URL; ?>/public/index.php?url=users/checkAdduser"
                    id="form-adduser">
                    ...
                    <div class="form-adduser-group">
                        <div>
                            ...
                            <input type="text" name="fullname" style="background-color:#DFDFDF80;" disabled
                        ...
                        <div>
                            ...
                            <div class="date-container">
                                <input id="birthDate" type="date" name="birthDate"
                                    ...
                                    disabled value="<?php echo $data['birthdate'] ?>">
                            </div>
                        </div>
                        <div></div>
                    </div>
                    ...
                    <div class="btn-adduser-group">
                        <button type="button" class="continue" id="btn-open" style="cursor: pointer;">Lưu lại</button>
                        <a href="<?php echo BASE_URL; ?>/public/index.php?url=users/backAddUser"><button type="button"
                                class="clear" style="cursor: pointer;">Quay lại</button></a>
                    </div>
